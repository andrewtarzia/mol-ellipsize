...
![Parity plots of the calculated molecular size $d$ versus the (a) reported kinetic diameters for all molecules in Table 1 and (b) critical diameters of small molecules extracted from ref. @webster1998.\label{fig:size_method_parity}](main_parities.pdf)
